      ...
      <div className="container relative z-10">
        <div className="grid items-center gap-12 py-10 lg:grid-cols-[1.1fr_0.72fr] lg:gap-16 lg:py-16">
          <div className="max-w-3xl">
            {/* h1 */}
            <motion.h1
              className="text-5xl leading-[0.92] text-foreground sm:text-6xl lg:text-7xl"
            ...
            <motion.p
              ...
              initial={{ y: 60, opacity: 0 }}
              animate={{ y: 0, opacity: 1 }}
              transition={{ duration: 0.8, delay: 0.15, ...easeOut }}
            >
            ...
            <motion.div
              ...
              initial={{ y: 60, opacity: 0 }}
              animate={{ y: 0, opacity: 1 }}
              transition={{ duration: 0.8, delay: 0.3, ...easeOut }}
            >
